<template>
  <div class="schema">
    <el-row class="api-header">
      ...
      <el-col :span="18" class="api-title" :title="api.url">
        {{api.url}}
      </el-col>
      <el-col :span="2" style="line-height: 56px">
        <el-button :type="btn[api.method]">{{api.method}}</el-button>
      </el-col>
    </el-row>
    <el-row>
      <el-col :span="20" :offset="2" style="padding: 15px;">
